...
class AvoidScene(Scene):
    def __init__(self, screen: pygame.Surface):
        self.avoid_button = GameObject((300, 300), (50, 50), utils.make_surface((10, 10), colors.WHITE))
        self.avoid_button.add_component(PhysicalComponent(1.0, 1.0))
        self.objects = [ 
            GameObject((0, 0), screen.get_size(), utils.make_surface(screen.get_size(), colors.BLACK)),
            self.avoid_button
        ]
    ...
    def update(self, dt: float):
        ...
        direction_vector = mouse_pos - self.avoid_button.get_pos_center()
